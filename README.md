# csn-dx24tt5-nguyenhoangcuong-python-calculator
Đồ án thực tập cơ sở ngành tìm hiểu về ngôn ngữ lập trình Python và xây dựng chương trình máy tính cầm tay
